...
public class DetailsOfEmployee {
	...
	public static void main(String[] args) throws Exception {
		...
		employees.add(new Employee1(1, "parul","paul ","94gmail","2299",new SimpleDateFormat("dd/MM/yyyy").parse("10/03/2020"),"software developer","it developer", 20000, 23));
		employees.add(new Employee1(2, "shephali","paul","09gmail","0052",new SimpleDateFormat("dd/MM/yyyy").parse("1/03/2010"),"jr software developer","it developer", 25000, 12));
		employees.add(new Employee1(3, "aayushi","tiwari ","2gmail","0044",new SimpleDateFormat("dd/MM/yyyy").parse("23/07/2021"),"hr","hr dept", 60000, 50));
		employees.add(new Employee1(5, "rahul","kumar ","85gmail","0078",new SimpleDateFormat("dd/MM/yyyy").parse("10/09/2011"),"sr software developer","it developer", 70000, 44));
		employees.add(new Employee1(6, "sonal","gupta ","s65gmail","0099",new SimpleDateFormat("dd/MM/yyyy").parse("10/03/2020"),"hr","hr dept000", 35000, 78));
		
		
		System.out.println("list of employees :"+employees);
		
		ArrayList<Department> department = new ArrayList<Department>();
		department.add(new Department(1,"Hr Department",01));
		department.add(new Department(2,"Front end",89));
		department.add(new Department(3,"Back end",58));
		department.add(new Department(4,"consultancy",55));
		
		
		DetailsOfEmployee stc = new DetailsOfEmployee();
