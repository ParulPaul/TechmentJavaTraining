...
public class ComparatorDemo2 {
	...
	public static void main(String[] args) {
		...
		p.add(new Product(1, "laptop" , 10000 ,2));
		p.add(new Product(3, "mobile" , 800 ,1));
		p.add(new Product(2, "charger" , 1000 ,1));
		p.add(new Product(3, "earpod" , 600 ,1));
		p.add(new Product(2, "cable-wire" , 1000 ,1));
